...
public class HeightStatusConfigurations
{
    ...
    public double lifeStatsIncreaseEveryHeight = 0.02;
    public double damageStatsIncreaseEveryHeight = 0.02;
    public double lootStatsIncreaseEveryHeight = 0.03;
    ...
    public double levelUPExperienceIncreaseEveryHeight = 0.01;
}
